    ...
    >
      <div className="w-full flex flex-col">
        ...
        <div className="mt-4 flex flex-col gap-1">
          {topPlays?.map((song, i) => {
            return <TopChartCard song={song} i={i} key={song.key} isPlaying={isPlaying} activeSong={activeSong} handlePauseClick={handlePauseClick} handlePlayClick={() => handlePlayClick(song, i)} />;
          })}
        </div>
